...
if (typeof define !== 'function' || !define.amd) {
  ...
  this.define = function(factory) {
    ...
    _this.ribcage.views.modelFormView = factory(_this.require);
    _this.ribcage.views.ModelFormView = _this.ribcage.views.modelFormView.View;
    return _this.ribcage.viewMixins.ModelFormView = _this.ribcage.views.modelFormView.mixin;
  };
}
